...
class ThemeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $themes = $em->getRepository('BaseBundle:Theme')->findAll();
    ...
    {
        $theme = new Theme();
        $form = $this->createForm('BaseBundle\Form\ThemeType', $theme);
    ...
    {
        $deleteForm = $this->createDeleteForm($theme);
        $editForm = $this->createForm('BaseBundle\Form\ThemeType', $theme);
